        ...
        <div className="flex-1 flex items-center justify-center px-6">
          <div className="card p-6 max-w-sm w-full">
            ...
            <div className="text-[13.5px] mb-4" style={{ color: "var(--text-mid)" }}>
              A management work-sample tool. It runs in your browser and talks to models through your own OpenRouter key — paste it once to begin.
            </div>
            ...
            <div className="text-[11px] italic mt-3" style={{ color: "var(--text-lo)" }}>
              Stored only in this browser (localStorage), sent only to OpenRouter. Keys at openrouter.ai/keys.
            </div>
          </div>
        </div>
      </div>
